...
object CurriesPAF extends App {
  ...
  // METHOD!
  def curriedMethod(x: Int)(y: Int): Int = x + y // curried method
  ...
  val add5 = curriedMethod(5) _ // Int => Int
  ...
  val add3_1 = (y: Int) => simpleAddFunction(5, y)
  val add3_2: Int => Int = y => simpleAddFunction(5, y)

  val add3_3 = simpleAddFunction.curried(5)
  add3_3(2)

  val add3_4 = simpleAddFunction(5, _)
  add3_4(4)

  val add3_5 = simpleAddFunction(5, _: Int)
  add3_5(5)


  val add4_1 = (y: Int) => simpleAddMethod(5, y)
  val add4_2: Int => Int = y => simpleAddMethod(5, y)

  val add4_3 = simpleAddMethod(5, _)
  add4_3(4)

  val add4_4 = simpleAddMethod(5, _: Int)
  add4_4(5)


  val add5_1 = (y: Int) => curriedAddMethod(5)(y)
  val add5_2: Int => Int = y => curriedAddMethod(5)(y)

  val add5_3 = curriedAddMethod(5)_
  add5_3(4)

  val add5_4 = curriedAddMethod(5)(_)
  add5_4(4)

  val add5_5 = curriedAddMethod(5)(_: Int)
  add5_5(5)
